      ...
      if (client.available()) {
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            client.println("<!DOCTYPE html><html><head><title>Hellen Lighting system</title>");
            ...
            client.println("<h1>Hellen Systems</h1>");
            ...
            client.println("</div>");
            client.println("<footer>&copy; 2025 Khanzila Hellen |</footer>");
